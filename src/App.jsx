...
function App() {
  ...
  const referenciaFicha = useRef(null)
  const handlePrint = useReactToPrint({
    contentRef: referenciaFicha,
  })
  return (
    <> {/* Abertura do FichaAnimal */}
      <main id='content'>
        ...
        {mostrarFicha && <FichaAnimal dados={informacao} referencia={referenciaFicha} />}
        {mostrarFicha && <button onClick={handlePrint}>Baixar PDF</button>}
      </main>
